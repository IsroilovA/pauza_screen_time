...
void main() {
  group('PauzaError.fromPlatformException', () {
    test('maps stable taxonomy codes to typed subclasses', () {
      expect(
        PauzaError.fromPlatformException(
          PlatformException(code: 'UNSUPPORTED'),
        ),
        isA<PauzaUnsupportedError>(),
      );
      expect(
        PauzaError.fromPlatformException(
          PlatformException(code: 'MISSING_PERMISSION'),
        ),
      ...
      expect(
        PauzaError.fromPlatformException(
          PlatformException(code: 'SYSTEM_RESTRICTED'),
        ),
    ...
    test('maps unknown codes to internal failure subtype', () {
      final error = PauzaError.fromPlatformException(
        PlatformException(code: 'SOME_LEGACY_CODE'),
      );
